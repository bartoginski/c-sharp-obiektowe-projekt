...
namespace ProgramowanieObiektoweProjekt.Bot.BotMedium
{
	class BotMedium : BotEasy.BotEasy, IBot
	{
		...
		public override Tuple<int, int> BotShotSelection()
		{
			...
			// Fallback do logiki BotEasy (strzelanie losowe), jeœli logika sektorowa równie¿ zawiedzie
		...
		{
			base.InformShotResult(shotCoordinates, result); // Wywo³aj logikê z klasy bazowej (BotEasy)
															// Tutaj mo¿na dodaæ specyficzn¹ dla BotMedium logikê przetwarzania wyniku, jeœli potrzebna
		}
	}
}